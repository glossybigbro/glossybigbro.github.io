...
export const introduce = {
    ...
    content: [
        <p key="p1" className="font-medium">
            Hello! I have <strong className="font-bold">8 years of Android development experience</strong> across various domains, and led teams as an <strong className="font-bold">Android Lead and Squad Development Team Lead</strong> in large-scale commerce services. Currently, I focus on setting technical direction through <strong className="font-bold">adopting new technologies</strong>, designing <strong className="font-bold">scalable architectures</strong>, <strong className="font-bold">automating development processes with CI/CD</strong>, and fostering effective team collaboration.
        </p>,
        <p key="p2">
